...
<p className="text-slate-600 text-sm mt-2">Phone: <a className="underline" href="tel:+61450090491">0450 090 491</a><br/>Email: <a className="underline" href="mailto:hello@focalvision.com.au">hello@focalvision.com.au</a><br/>Location: Sydney, NSW</p></div>
